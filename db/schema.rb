...
ActiveRecord::Schema[7.0].define(version: 20_251_229_121_945) do
  ...
  create_table 'address_statuses', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[uuid refresh_datetime], name: 'index_address_statuses_on_uuid_and_refresh_datetime', unique: true
  end
  ...
  create_table 'bulk_fit_tests_imports', force: :cascade do |t|
    ...
    t.jsonb 'procedure_values_matching', default: {}, null: false
    t.jsonb 'from_file_mask_breakdowns', default: {}, null: false
    t.jsonb 'from_file_mask_breakdown_errors', default: {}, null: false
  ...
  create_table 'carbon_dioxide_monitors', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[serial model], name: 'index_carbon_dioxide_monitors_on_serial_and_model', unique: true
  ...
  create_table 'digital_caliper_statuses', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[uuid refresh_datetime facial_measurement_kit_uuid],
            name: 'index_dig_cal_sta_on_uuid_refr_fm_kit_uuid', unique: true
  end
  ...
  create_table 'facial_measurement_kit_statuses', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[uuid refresh_datetime], name: 'index_fmks_on_uuid_refr_datetime__unique_true', unique: true
  end
  ...
  create_table 'hood_statuses', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[uuid refresh_datetime], name: 'index_hood_statuses_on_uuid_and_refresh_datetime', unique: true
  ...
  create_table 'mask_kit_statuses', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[uuid mask_uuid refresh_datetime], name: 'index_uuid_mask_uuid_datetime_on_mkst', unique: true
  end

  create_table 'mask_pairs', force: :cascade do |t|
    t.bigint 'mask_a_id', null: false
    t.bigint 'mask_b_id', null: false
    t.jsonb 'history', default: [], null: false
    t.float 'name_distance', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[mask_a_id mask_b_id], name: 'index_mask_pairs_on_mask_a_id_and_mask_b_id', unique: true
  ...
  create_table 'qualitative_fit_testing_kit_joins', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[qlft_kit_uuid part_uuid refresh_datetime],
            name: 'index_qlft_kit_join_on_qlft_kit_uuid_part_uuid_refresh_datetime', unique: true
  end
  ...
  create_table 'qualitative_fit_testing_kit_statuses', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[uuid refresh_datetime type], name: 'index_qlft_kit_on_uuid_refresh_datetime_type_unique_true',
                                            unique: true
  end
  ...
  create_table 'shipping_status_joins', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[shipping_uuid shippable_uuid refresh_datetime],
  ...
  create_table 'shipping_statuses', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[uuid refresh_datetime], name: 'index_shipping_statuses_on_uuid_and_refresh_datetime', unique: true
  end
  ...
  create_table 'solution_statuses', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[uuid refresh_datetime], name: 'index_solution_statuses_on_uuid_and_refresh_datetime', unique: true
  ...
  create_table 'study_participant_statuses', force: :cascade do |t|
    ...
    t.index %w[study_uuid participant_uuid refresh_datetime],
            name: 'index_stu_par_sta_on_study_uuid_participant_uuid_refr_dt', unique: true
  end
  ...
  create_table 'study_statuses', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[uuid name refresh_datetime], name: 'index_study_statuses_on_uuid_and_name_and_refresh_datetime',
                                            unique: true
  end
  ...
  create_table 'tape_measure_statuses', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[uuid refresh_datetime facial_measurement_kit_uuid],
            name: 'index_tape_mea_sta_on_uuid_refr_fm_kit_uuid', unique: true
  end
