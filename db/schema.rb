...
ActiveRecord::Schema[7.0].define(version: 2026_02_16_180000) do
  ...
  create_table "facial_measurements", force: :cascade do |t|
    ...
    t.index ["user_id", "created_at"], name: "index_facial_measurements_on_user_id_and_created_at_desc", order: { created_at: :desc }
  ...
  create_table "mask_events", force: :cascade do |t|
    ...
    t.index ["mask_id", "created_at"], name: "index_mask_events_on_mask_id_and_created_at"
  ...
  create_table "mask_pairs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["mask_a_id", "mask_b_id"], name: "index_mask_pairs_on_mask_a_id_and_mask_b_id", unique: true
  ...
  create_table "mask_states", force: :cascade do |t|
    ...
    t.index ["mask_id", "created_at"], name: "index_mask_states_on_mask_id_and_created_at"
  ...
  create_table "user_carbon_dioxide_monitors", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["serial", "model", "user_id"], name: "index_user_carbon_dioxide_monitors_on_serial_model_user_id", unique: true
