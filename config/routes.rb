...
Rails.application.routes.draw do
  ...
  get 'facial_measurements/summary', to: 'facial_measurements_summary#index'
  ...
  get 'bulk_fit_tests_imports', to: 'bulk_fit_tests_imports#index'
  ...
  get 'masks/:mask_id/events', to: 'mask_events#index', defaults: { format: :json }
