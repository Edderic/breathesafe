export function getFacialMeasurements() {
  return {
    ...
    'bitragionMentonArcMm': {
      ...
      'value': this.bitragionMentonArcMm,
    ...
    'headCircumferenceMm': {
      ...
      'value': this.headCircumfderenceMm,
