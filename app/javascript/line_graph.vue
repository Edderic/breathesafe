<template>
  <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" :viewBox="viewBox" height='20em' :width='width'>
    <text class='label' x="10%" y="45%" text-anchor="middle" fill="black" dy=".4em" style="font-size: 20em" transform='translate(-3500, 6000) rotate(-90)'>{{ylabel}}</text>
