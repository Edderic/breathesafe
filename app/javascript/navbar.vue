  ...
  <div class='navbar-top-container'>
    ...
    <div class='row spaced-between main fixed-nav-bar'>
      ...
      <div class='vertical-centered'>
        ...
        <router-link class='desktop clickable side-padding' :to='{ name: "Methodology"}' @click='showSubNavBar = null'>Methodology</router-link>
    ...
    <div class='mobile-col' v-if="showMobile()">
      ...
      <router-link class='mobile-row clickable side-padding' :to='{ name: "Methodology"}' @click='showSubNavBar = null'>Methodology</router-link>
